            ...
            <TabsContent value="orders" className="p-8 mt-0 outline-none">
              {loadingOrders ? (
                ...
                <div className="bg-white rounded-3xl border border-gray-100 shadow-xl shadow-gray-200/50 overflow-hidden">
                  <Table>
                    <TableHeader className="bg-gray-50/50 border-b border-gray-100">
                      <TableRow>
                        <TableHead className="text-[10px] font-black uppercase tracking-widest py-4 pl-6">
                          Order Registry
                        </TableHead>
                        ...
                        <TableHead className="text-right text-[10px] font-black uppercase tracking-widest py-4 pr-6">
                          Directives
                        </TableHead>
                      </TableRow>
                    </TableHeader>
                ...
                <div className="py-24 text-center border-2 border-dashed border-gray-100 rounded-[2.5rem] bg-gray-50/30">
                  ...
                  <h3 className="text-sm font-black uppercase tracking-widest text-muted-foreground/30">
