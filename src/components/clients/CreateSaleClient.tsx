...
import { SaleScanner } from "@/components/sales/SaleScanner";
import { EnhancedClientSelector } from "@/components/sales/EnhancedClientSelector";
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Create a new customer sale and record payment.
            </p>
          </div>
        </div>
      </div>
