    ...
    <Card className="border shadow-sm overflow-hidden">
      <CardHeader className="pb-3 border-b flex flex-row items-center justify-between">
        <CardTitle className="text-lg flex items-center gap-2">
          ...
          {isSale ? "Current Sale Items" : "Order Items"}
        </CardTitle>
        <span className={cn(
          "px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-widest border",
          isSale ? "bg-green-100/50 border-green-200 text-green-700" : "bg-blue-100/50 border-blue-200 text-blue-700"
        )}>
        ...
        <Table>
          <TableHeader>
            <TableRow className={cn("header-row", headerBg)}>
              <TableHead className="font-bold text-xs uppercase tracking-wider pl-6">Item Details</TableHead>
              <TableHead className="text-center w-[130px] font-bold text-xs uppercase tracking-wider">Qty</TableHead>
              <TableHead className="text-right w-[150px] font-bold text-xs uppercase tracking-wider">
                {isSale ? "Selling Price" : "Unit Cost"}
              </TableHead>
              <TableHead className="text-right w-[150px] font-bold text-xs uppercase tracking-wider pr-6">Total</TableHead>
                ...
                >
                  <div className="flex flex-col items-center justify-center gap-3 grayscale opacity-30">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-[11px]">Search and add items to begin this transaction</p>
                    </div>
                  </div>
                </TableCell>
              </TableRow>
